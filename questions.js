...
},
{
    ...
    answer:["True or False" , "Yes or No", "This or That", "Now or Later"],
    correctAnswer: "True or False"
},
{
    questionTitle:"What is the correct way to call function codeQuiz()?",
    answer:["codeQuiz();" , "function codeQuiz();", "codeQuiz()", "function();"],
    correctAnswer:"codeQuiz();"
},
{
    questionTitle:"What does DOM stand for?",
    answer:["Document Object Model" , "Nothing", "Document On Model", "Do On Model"],
    correctAnswer: "Document Object Model"
},
{
    questionTitle: "What data type below is not supported by javaScript?",
    answer:["Chapter" , "String", "Symbol", "Number"],
    correctAnswer:"Chapter"
},
{
    questionTitle: "How can you create an object in JavaScript?",
    answer:["using object literal" , "typing in object", "you can't", "using brackets"],
    correctAnswer: "using object literal"
},
{
    questionTitle:"Which way can JavaScript code NOT be involved in an HTML File?",
    answer:["On Top" , "Inline", "Internal", "External"],
    correctAnswer: "On Top"
},
{
    questionTitle:"What is innerHTML?",
    answer:["it will process an HTML tag if fond in a string" , "it will not process an HTML tag if fond in a string", "it is all the code in the HTML file", "it returns NaN"],
...
},
{
    ...
    answer:["console.log(var)" , "consoleLog(var)", "log(var)", "cl(var)"],
